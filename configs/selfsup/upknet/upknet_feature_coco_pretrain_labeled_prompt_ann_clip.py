...
LastEditTime: 2024-01-02 07:45:47
...
custom_imports = dict(
    imports=[
        ...
        'custommd.models.detectors.upknet_feature_clip',
        'custommd.models.kernel_updator',
        'custommd.models.knet.kernel_head',
        'custommd.models.knet.kernel_iter_head_clip',
        'custommd.models.knet.kernel_update_head_clip',
        'custommd.models.knet.semantic_fpn_wrapper',
        'custommd.models.knet.mask_hungarian_assigner',
        'custommd.models.knet.mask_hungarian_clip_assigner',
    ],
    allow_failed_imports=False)

_base_ = [
    '../_base_/schedules/schedule_1x.py',
    '../_base_/models/upknet_s3_r50_fpn_test_ann_clip.py',
