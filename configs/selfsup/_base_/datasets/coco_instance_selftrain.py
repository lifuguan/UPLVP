...
train_pipeline = [
    ...
    dict(type='Collect', keys=['img', 'gt_labels', 'gt_masks', 'gt_bboxes']),
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_train2017_unlabeled2017_freesolo_pl.json',
