...
custom_imports = dict(
    imports=[
        ...
        'mmdet.models',
        'custommd.datasets.selfmask',
        'custommd.datasets.coco_pseudo',
        'custommd.datasets.data_source.custom_imagenet',
        'custommd.pipelines.transforms',
        'custommd.models.detectors.upknet',
...
model = dict(
    ...
    backbone=dict(
        ...
        style='pytorch',
        init_cfg=dict(
            type='Pretrained', checkpoint='model_zoo/densecl_resnet50.pth')), # torchvision://resnet50
    neck=dict(
        type='FPN',
    ...
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                type='OurMaskHungarianAssigner',
                cls_cost=dict(type='FocalLossCost', weight=1.0),
                dice_cost=dict(type='OurDiceCost', weight=1.0, pred_act=True),
                project_weight=1.0,
                avg_weight=5.0),
