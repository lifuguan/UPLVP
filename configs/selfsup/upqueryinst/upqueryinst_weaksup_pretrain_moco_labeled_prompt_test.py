...
LastEditTime: 2022-06-03 09:58:57
...
custom_imports = dict(
    imports=[
        'custommd.models.detectors.upqueryinst_prompt',
        'custommd.models.upqueryinst.updynamic_mask_head',
