...
LastEditTime: 2022-07-26 14:35:57
...
# learning policy
lr_config = dict(policy='step', step=[36, 44], warmup_iters=100)
runner = dict(type='EpochBasedRunner', max_epochs=48)

load_from = "work_dirs/upqueryinst_r50_fpn_1x_coco_pretrain_moco_labeled_prompt_concat/epoch_12.pth"
