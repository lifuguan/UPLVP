...
from ..oursnet.utils import mask2bbox, sem2ins_masks, mask_matrix_nms, matrix_nms, center_of_mass, median_blur, GaussianBlur

# @ALGORITHMS.register_module()
@DETECTORS.register_module()
class OursNet(TwoStageDetector):
    ...
    def __init__(self,
        ...
        self.upscale_kernel_factor = 40000  # 对kernel的比例缩放，适配rpn出的kernel
    ...
    def extract_patches(self, imgs, img_metas, gt_masks):
    ...
    def forward_train(self,
        ...
        patch_feats = self.extract_patches(img, img_metas, gt_masks)
