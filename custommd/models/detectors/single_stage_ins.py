'''
Author: your name
Date: 2022-02-21 16:01:38
LastEditTime: 2022-02-23 21:09:14
LastEditors: Please set LastEditors
Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
FilePath: /research_workspace/custommd/models/detectors/single_stage_ins.py
'''
...
class SingleStageInsDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        super(SingleStageInsDetector, self).__init__(init_cfg=init_cfg)
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        outs = self.bbox_head(feat, eval = True)
        if self.with_mask:
            mask_feat_pred = self.mask_head(
                feat[self.mask_head.
                  start_level:self.mask_head.end_level + 1])
        ...
        # based on single_stage_instance_seg.py
        format_results_list = []
    ...
    def format_results(self, results):
        ...
        assert 'scores' in data_keys, 'data_keys: {}'.format(data_keys)
