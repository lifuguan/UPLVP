...
class MaskCost(object):
    ...
    def __call__(self, cls_pred, target):
        ...
        return cls_cost * self.weight   # weight = 4


@BBOX_ASSIGNERS.register_module(force=True)
class MaskHungarianPositionAssigner(BaseAssigner):
    ...
    def __init__(self,
        ...
        self.mask_cost_pos = build_match_cost(mask_cost_pos)
        self.dice_cost = build_match_cost(dice_cost)
        self.dice_cost_pos = build_match_cost(dice_cost_pos)
    ...
    def assign(self,
        ...
        if self.mask_cost.weight != 0:
            ...
            reg_cost = 0
        if self.mask_cost_pos.weight != 0:
            reg_cost_pos = self.mask_cost_pos(pos_pred, gt_poses)
        else:
            reg_cost_pos = 0
        if self.dice_cost.weight != 0:
            ...
            dice_cost = 0
        if self.dice_cost_pos.weight != 0:
            dice_cost_pos = self.dice_cost_pos(pos_pred, gt_poses)  # -1.40, -1.29
        else:
            dice_cost_pos = 0
        if self.boundary_cost is not None and self.boundary_cost.weight != 0:
            ...
            b_cost = 0
        cost = cls_cost + reg_cost + reg_cost_pos + dice_cost + dice_cost_pos + b_cost  # -1.6, -1.4
