...
class UpDynamicMaskHead(FCNMaskHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(UpDynamicMaskHead, self).__init__(
            num_convs=num_convs,
        ...
        self.loss_avg = build_loss(loss_avg)
    ...
    def loss(self, mask_pred, mask_targets, labels):
        ...
        if mask_pred.size(0) == 0:
            ...
            loss_proj = self.loss_proj(
                mask_pred[torch.arange(num_pos).long(), labels, ...].sigmoid(),
                mask_targets)
        loss['loss_mask'] = loss_avg + loss_proj
        return loss
