...
class OursConvKernelHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(OursConvKernelHead, self).__init__()
        self.bs = batch_size
    ...
    def _decode_init_proposals(self, img, img_metas):
        ...
        # save_test_info(None, None, scaled_mask_preds=mask_preds)
    ...
    def forward_train(self,
        ...
        if cls_scores is None:
            detached_cls_scores = [None] * self.bs # batch size
        else:
    ...
    def loss(self,
        ...
        if pos_inds.any():
            ...
            losses['loss_rpn_avg'] = self.loss_mask(pos_mask_pred,
                                                     pos_mask_targets)
            losses['loss_rpn_projection'] = self.loss_dice(pos_mask_pred,
                                                     pos_mask_targets)
